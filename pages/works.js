  ...
  return (
    <Container variant="customCard" maxW="container.lg">
      ...
      >
        ...
        over the years. I wanted to make this, other than the showcase itself,
        to learn ReactJS, and how to build a proper website with it. <br />I
        also used the opportunity to try my hand a little at design, which I
        usually leave to those in charge. <br />
        As for the interface, it was done using the "Chakra UI" library, and as
        an aid to using the library, I followed the video and then also a few
        lines of code from&nbsp;
        <Link
      ...
      >
        ...
        winners of <i>Swift Student Challenge 2023</i>, that basically explains
        a math problem: The Buffon's needles problem. <br />
        <br />
        ...
        in equal sections, and let an indefinite number of needles drop on this
        surface, the probability for the needles to land of the dividers, after
        a long series of calculation, is related to the number Pi. <br /> So
        actually, if you reverse the formula, and approximate the probability
        for the needles to land on the surface dividers as the numbers of
        needles actually landed on the dividers over the total number of landed
        needles, you can actually calculate the number Pi, as accurate as the
        number of needles grows.
      </WorkListElement>
      <WorkListElement
      ...
      >
        ...
        some of the known sorting algorithms work, with a simple explanation and
        a little animation to show how it's done.
      ...
      >
        ...
        <br />
        The timer is the animated piece in this project: basically, I wanted to
        make as big as possible the visibility of how much time is remaining for
        the rest between sets, in order to help the, supposed tired, user better
        read the screen.
        <br /> Current versions: <br />
        <List>
          <ListItem>
            <ListIcon as={BiLogoFlutter} color="#ff6e00" />
            <b>Flutter</b>: made to learn Flutter and Dart for the hybrid
            development. Initially made in august 2022, I decided to remake it,
            in order to refactor the code in a more readable way, using the MVVM
            pattern. <br />
            Being a standalone project done for personal growth reasons, I made
            everything, from the design to the implementation of the app, also
